...
- 🥇 **N-BEATS Model**: **2,091.32** (ვალიდაცია) / **2,481.76** (submission) - **საუკეთესო შედეგი**
...
-   ვალიდაციის ეტაპზე N-BEATS-მა აჩვენა **საუკეთესო შედეგი** სხვა მოდელებთან შედარებით. საუკეთესო ჰიპერპარამეტრებით მიღებული WMAE ვალიდაციის მონაცემებზე იყო **2091.32**.
